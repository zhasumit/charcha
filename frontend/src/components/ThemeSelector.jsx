...
const ThemeSelector = () => {
    ...
    return (
        <div className="dropdown dropdown-end">
            ...
            >
                <Paintbrush className="h-6 w-6 opacity-70 group-hover:opacity-100 transition-opacity duration-300" />
            </button>

            <div
                tabIndex={0}
                className="dropdown-content mt-2 p-1 shadow-2xl bg-base-200 backdrop-blur-lg rounded-2xl
                    w-44 border border-base-content/10 max-h-80 overflow-y-auto left-1/2 -translate-x-1/2"
            >
